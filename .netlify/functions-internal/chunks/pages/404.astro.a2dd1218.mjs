import { c as createAstro, a as createComponent, r as renderTemplate, b as renderSlot, d as renderHead, e as addAttribute, m as maybeRenderHead, f as renderComponent, F as Fragment, u as unescapeHTML } from '../astro.37205a1e.mjs';
/* empty css                         *//* empty css                         */
const SITE = {
...
}, "C:/Users/Raviel007/Desktop/Web_Dev/Astro-Project/Santiago-Landing/src/layouts/Layout.astro");
...
}, "C:/Users/Raviel007/Desktop/Web_Dev/Astro-Project/Santiago-Landing/src/components/Hr.astro");
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="nav-container animate__animated animate__slideInUp astro-3EF6KSR2">
    <div class="top-nav-wrap astro-3EF6KSR2">
      <nav id="nav-menu" class="flex justify-between astro-3EF6KSR2">
        <a href="/" class="logo astro-3EF6KSR2">
          <img alt="Logo" src="/assets/logo.png" class="flex h-56 w-auto astro-3EF6KSR2"></a>
        ...
        <ul id="menu-items" class="display-none sm:flex astro-3EF6KSR2">
          <li class="astro-3EF6KSR2">
            <a id="about-nav" href="/about"${addAttribute((activeNav === "about" ? "active" : "") + " astro-3EF6KSR2", "class")}>
              About
            </a>
          </li>
          <li class="astro-3EF6KSR2">
            <a id="projects-nav" href="/projects"${addAttribute((activeNav === "projects" ? "active" : "") + " astro-3EF6KSR2", "class")}>
              Projects</a>
          </li>
          <li class="astro-3EF6KSR2">
            <a id="contact-nav" href="/contact"${addAttribute((activeNav === "contact" ? "active" : "") + " astro-3EF6KSR2", "class")}>
              Contact
            </a>
          </li>
          <li class="astro-3EF6KSR2">
...
}, "C:/Users/Raviel007/Desktop/Web_Dev/Astro-Project/Santiago-Landing/src/components/Header.astro");
...
const $$LinkButton = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead($$result)}<a${addAttribute(disabled ? "#" : href, "href")}${addAttribute(disabled ? "-1" : "0", "tabindex")}${addAttribute(`group inline-block ${className} astro-5EUNQZKT`, "class")}${addAttribute(ariaLabel, "aria-label")}${addAttribute(title, "title")}${addAttribute(disabled, "aria-disabled")} rel="noopener noreferrer" target="_blank">
  ${renderSlot($$result, $$slots["default"])}
</a>`;
}, "C:/Users/Raviel007/Desktop/Web_Dev/Astro-Project/Santiago-Landing/src/components/LinkButton.astro");
...
}, "C:/Users/Raviel007/Desktop/Web_Dev/Astro-Project/Santiago-Landing/src/components/Socials.astro");
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="footer-wrapper astro-SZ7XMLTE">
    ...
    <div class="copyright-wrapper astro-SZ7XMLTE">
      <span class="astro-SZ7XMLTE">Copyright &#169; ${currentYear}</span>
      <span class="separator astro-SZ7XMLTE">&nbsp;|&nbsp;</span>
      <span class="astro-SZ7XMLTE">All rights reserved.</span>
    </div>
  </div>
</footer>`;
}, "C:/Users/Raviel007/Desktop/Web_Dev/Astro-Project/Santiago-Landing/src/components/Footer.astro");
...
` })}`;
}, "C:/Users/Raviel007/Desktop/Web_Dev/Astro-Project/Santiago-Landing/src/pages/404.astro");

const $$file = "C:/Users/Raviel007/Desktop/Web_Dev/Astro-Project/Santiago-Landing/src/pages/404.astro";
const $$url = "/404";
...
export { $$Header as $, _404 as _, $$Footer as a, $$Layout as b, $$LinkButton as c, $$Hr as d };
