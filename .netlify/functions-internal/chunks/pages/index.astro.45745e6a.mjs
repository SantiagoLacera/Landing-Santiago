...
import { $ as $$Header, c as $$LinkButton, a as $$Footer, b as $$Layout } from './404.astro.bf8fcbc3.mjs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead($$result2)}<main id="main-content" class="animate__animated animate__slideInUp astro-J7PV25F6">
    <section id="hero" class="astro-J7PV25F6">
      ...
      <p class="astro-J7PV25F6">
        This Website uses a template from
        ${renderComponent($$result2, "LinkButton", $$LinkButton, { "className": "hover:text-skin-accent underline underline-offset-4 decoration-dashed astro-J7PV25F6", "href": "https://github.com/satnaing/astro-paper#readme" }, { "default": ($$result3) => renderTemplate`
          Astro-paper
        ` })} click for more info.
      </p>
    </section>
