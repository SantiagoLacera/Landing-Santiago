...
import { $ as $$Header, d as $$Hr, a as $$Footer, b as $$Layout } from './404.astro.39f7c7ed.mjs';
import { $ as $$Breadcrumbs$1 } from './about.astro.713b4edf.mjs';
...
const $$ContentMedia = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead($$result)}<section class="flex justify-center py-10 opacity-80">
  <div class="container">
    <div class="md:grid-cols-2 grid grid-cols-1">
      ${!reverseImg ? renderTemplate`${renderComponent($$result, "Media", $$Media, { "class": "rounded-lg ", "src": imgSrc })}` : ""}
...
const $$Projects = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead($$result2)}<main id="main-content" class="headline astro-AID3SR62">
    <section id="hero" class="astro-AID3SR62">
      ...
      <div id="company-website" class="topBar inset-0 mb-10 rounded-md border-2 border-cyan-600 bg-[url('/assets/horses-background.gif')] bg-cover bg-no-repeat pb-2 shadow-md astro-AID3SR62">
      ...
      <div id="personal-website" class="topBar inset-0 mb-10 rounded-md border-2 border-[#eae6e3] bg-[url('/assets/personal-background.webp')] bg-cover pb-2 pt-5 shadow-md astro-AID3SR62">
        <a href="https://santiagolacera.github.io/Lu-Martinez-Design/" class="astro-AID3SR62">
          ${renderComponent($$result2, "ContentMedia", $$ContentMedia, { "imgSrc": "/assets/personal-website.png", "class": "astro-AID3SR62" })}
        </a>
        <p class="backOutline animate__animated animate__slideInDown astro-AID3SR62">
      ...
      <div id="terminal" class="topBar inset-0 z-10 mb-10 rounded-md border-2 border-green-500 bg-[url('/assets/terminal-background.gif')] shadow-md astro-AID3SR62">
        <a href="https://santiagolacera.github.io/Terminal-SL/" class="astro-AID3SR62">
          ${renderComponent($$result2, "ContentMedia", $$ContentMedia, { "imgSrc": "/assets/terminal.png", "class": "astro-AID3SR62" })}
        </a>
        <p class="backOutline animate__animated animate__slideInDown astro-AID3SR62">
